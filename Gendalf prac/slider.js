(function () {
    ...
    class Slider {
      constructor(id, mediaQueries) {
        ...
        this.sliderList = this.slider.querySelector('.new_slider-list');
        this.sliderItems = this.slider.querySelectorAll('.new_slider-item');
        this.sliderNext = this.slider.querySelector('.nxt-btn');
        this.sliderPrev = this.slider.querySelector('.pre-btn');
